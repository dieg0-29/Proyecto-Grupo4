...
(1, 1, 1, '2024-01-12', 'Ocurrió 30 minutos de partir. No hubo heridos'),
(2, 2, 2, '2024-02-15', 'Fallo en el motor. No hubo heridos'),
(3, 3, 3, '2024-03-05', 'Problema con la batería. No hubo heridos'),
...
(3, 3, 3, '2024-03-06', 3, 250.00, 'Cambio de batería'),
(4, 4, 4, '2024-04-04', 4, 400.00, 'Puerta reparada'),
(5, 5, 5, '2024-05-26', 2, 350.00, 'Ventanas cambiadas. Se aplicó una capa de pintura al carro');
go
select * From CARRO;
